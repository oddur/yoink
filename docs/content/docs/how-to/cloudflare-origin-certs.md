...
- [Defense-in-depth web serving](/docs/how-to/defense-in-depth) — Origin Certs are the bottom layer; this recipe stacks CrowdSec + Coraza on top.
- [Multi-host LE with Redis storage](/docs/how-to/multi-host-redis-storage) — for the Let's Encrypt path when you don't want to use Cloudflare.
