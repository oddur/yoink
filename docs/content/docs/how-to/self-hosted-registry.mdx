...
description: "Run registry:2 as a yoink-managed service, expose it over the tailnet, and push images to it."
weight: 11
---
...
### Declare the registry as just another service in your `yoink.yaml` [step]
...
### Point your app's `image:` at the tailnet hostname [step]
